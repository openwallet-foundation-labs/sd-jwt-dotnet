...
> | Complexity   | High                                                                                                                                                                    |
> | Key Packages | `SdJwt.Net.Eudiw`, `SdJwt.Net.Oid4Vp`, `SdJwt.Net.OidFederation`, `SdJwt.Net.HAIP`, `SdJwt.Net.PresentationExchange`                                                    |
...
| [EUDIW Cross-Border Verification](eudiw-cross-border-verification.md) | Extended - KYC, healthcare, and education verification scenarios |
