...
Credential:
: A set of one or more claims about a subject made by a Credential Issuer. In this specification, Credentials are usually Verifiable Credentials (defined below). Note that the definition of the term â€œCredentialâ€ in this specification is different from that in [@!OpenID.Core].
...
The Digital Credentials Query Language (DCQL, pronounced [ËˆdaklÌ©]) is a
...
<reference anchor="JSON-LD" target="https://www.w3.org/TR/json-ld11/">
  <front>
    ...
    <author fullname="Pierre-Antoine Champin">
      <organization>LIRIS - UniversitÃ© de Lyon</organization>
    </author>
...
<reference anchor="ISO.23220-2" target="https://www.iso.org/standard/86782.html">
        <front>
          <title>ISO/IEC TS 23220-2 Personal identification â€” Building blocks for identity management via mobile devices, Part 2: Data objects and encoding rules for generic eID systems</title>
          <author>
            <organization> ISO/IEC JTC 1/SC 17 Cards and security devices for personal identification</organization>
          </author>
          <date year="2024"/>
...
<reference anchor="ISO.23220-4" target="https://www.iso.org/standard/86785.html">
        <front>
          <title>ISO/IEC CD TS 23220-4 Personal identification â€” Building blocks for identity management via mobile devices, Part 4: Protocols and services for operational phase</title>
          <author>
            <organization> ISO/IEC JTC 1/SC 17 Cards and security devices for personal identification</organization>
          </author>
          <date year="2025"/>
...
84                                 # array(4)
  ...
  58 20                            #   bytes(32)
    4283ec927ae0f208daaa2d026a814f #     "B\x83Ã¬\x92zÃ Ã²\x08ÃšÂª-\x02j\x81O"
    2b22dca52cf85ffa8f3f8626c6bd66 #     "+"ÃœÂ¥,Ã¸_Ãº\x8f?\x86&Ã†Â½f"
    9047                           #     "\x90G"
  78 1c                            #   string(28)
...
82                                 # array(2)
  ...
  58 20                            #   bytes(32)
    ...
    c69e371d5d68cea09cb4c48ca6daab #     "Ã†\x9e7\x1d]hÃŽ\xa0\x9cÂ´Ã„\x8cÂ¦ÃšÂ«"
    761a                           #     "v\x1a"
```
...
83                                 # array(3)
  ...
  82                               #   array(2)
    ...
    58 20                          #     bytes(32)
      ...
      b8c69e371d5d68cea09cb4c48ca6 #       "Â¸Ã†\x9e7\x1d]hÃŽ\xa0\x9cÂ´Ã„\x8cÂ¦"
      daab761a                     #       "ÃšÂ«v\x1a"
```
