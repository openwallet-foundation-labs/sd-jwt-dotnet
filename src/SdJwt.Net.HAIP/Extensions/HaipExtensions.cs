...
public interface IHaipOid4VciOptions
{
    ...
    /// </summary>
    string[]? AllowedSigningAlgorithms
    {
        get; set;
    }
    ...
    /// </summary>
    string[]? ForbiddenSigningAlgorithms
    {
        get; set;
    }
    ...
    /// </summary>
    bool RequireHardwareSecurityModule
    {
        get; set;
    }
    ...
    /// </summary>
    bool RequireQualifiedElectronicSignature
    {
        get; set;
    }
    ...
    /// </summary>
    bool RequireQualifiedWalletAttestation
    {
        get; set;
    }
...
public interface IHaipOid4VpOptions
{
    ...
    /// </summary>
    bool RequireVerifierAttestation
    {
        get; set;
    }
    ...
    /// </summary>
    bool RequireQualifiedVerifierAttestation
    {
        get; set;
    }
}
...
public class HaipIssuanceValidationContext
{
    ...
    /// </summary>
    public Microsoft.IdentityModel.Tokens.SecurityKey? SigningKey
    {
        get; set;
    }
    ...
    /// </summary>
    public bool HasWalletAttestation
    {
        get; set;
    }
