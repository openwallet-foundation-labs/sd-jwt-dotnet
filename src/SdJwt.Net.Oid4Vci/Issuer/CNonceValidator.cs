...
public sealed class ProofValidationOptions
{
    ...
    /// </summary>
    public Func<string, SecurityKey?>? KeyResolver
    {
        get; set;
    }
    ...
    /// </summary>
    public bool RequireKeyAttestation
    {
        get; set;
    }
    ...
    /// </summary>
    public Func<string, JwtSecurityToken, JwtHeader, bool>? KeyAttestationValidator
    {
        get; set;
    }
    ...
    /// </summary>
    public IReadOnlyCollection<string> AttestationHeaderNames
    {
        get; set;
    } =
...
#pragma warning restore SYSLIB0057
    ...
    private sealed class HeaderKeyMaterial
    {
        ...
        public IReadOnlyList<X509Certificate2>? X5cChain
        {
            get;
        }
    }
