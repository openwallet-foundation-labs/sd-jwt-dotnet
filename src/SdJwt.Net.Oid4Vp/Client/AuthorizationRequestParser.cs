...
public sealed class AuthorizationRequestParserOptions
{
    ...
    /// </summary>
    public bool RequireJarSignatureValidation
    {
        get; set;
    }
    ...
    /// </summary>
    public TokenValidationParameters? JarValidationParameters
    {
        get; set;
    }
    ...
    /// </summary>
    public Func<JwtSecurityToken, SecurityKey?>? JarSigningKeyResolver
    {
        get; set;
    }
    ...
    /// </summary>
    public Func<JwtSecurityToken, bool>? JarTrustValidator
    {
        get; set;
    }
