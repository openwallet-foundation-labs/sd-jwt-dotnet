...
public class EntityMetadata
{
    ...
    public FederationEntityMetadata? FederationEntity
    {
        get; set;
    }
    ...
    public object? OpenIdRelyingParty
    {
        get; set;
    }
    ...
    public object? OAuthAuthorizationServer
    {
        get; set;
    }
    ...
    public object? OpenIdCredentialIssuer
    {
        get; set;
    }
    ...
    public object? OpenIdRelyingPartyVerifier
    {
        get; set;
    }
...
public class FederationEntityMetadata
{
    ...
    public string? FederationFetchEndpoint
    {
        get; set;
    }
    ...
    public string? FederationListEndpoint
    {
        get; set;
    }
    ...
    public string? FederationResolveEndpoint
    {
        get; set;
    }
    ...
    public string? FederationTrustMarkStatusEndpoint
    {
        get; set;
    }
