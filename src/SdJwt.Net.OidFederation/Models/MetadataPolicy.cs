...
public class MetadataPolicy
{
    ...
    public MetadataPolicyRules? FederationEntity
    {
        get; set;
    }
    ...
    public MetadataPolicyRules? OpenIdRelyingParty
    {
        get; set;
    }
    ...
    public MetadataPolicyRules? OpenIdProvider
    {
        get; set;
    }
    ...
    public MetadataPolicyRules? OAuthAuthorizationServer
    {
        get; set;
    }
    ...
    public MetadataPolicyRules? OpenIdCredentialIssuer
    {
        get; set;
    }
    ...
    public MetadataPolicyRules? OpenIdRelyingPartyVerifier
    {
        get; set;
    }
    ...
    /// </summary>
    [JsonExtensionData]
    public Dictionary<string, MetadataPolicyRules>? AdditionalPolicies
    {
        get; set;
    }
...
public class MetadataPolicyRules
{
    ...
    /// </summary>
    [JsonExtensionData]
    public Dictionary<string, object>? FieldPolicies
    {
        get; set;
    }
