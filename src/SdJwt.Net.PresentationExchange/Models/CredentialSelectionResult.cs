...
public class CredentialSelectionResult
{
    ...
    /// </summary>
    public CredentialSelectionMetadata? Metadata { get; set; }
...
public class CredentialSelectionMetadata
{
    ...
    /// </summary>
    public DateTimeOffset? SelectionCompleted { get; set; }
...
public class InputDescriptorMapping
{
    ...
    public PathMapping? PathNested { get; set; }
