...
public class InputDescriptor {
        ...
        public string[] GetAcceptedFormats() {
                ...
                if (Format.Jwt != null) formats.Add(PresentationExchangeConstants.Formats.Jwt);
                if (Format.JwtVc != null) formats.Add(PresentationExchangeConstants.Formats.JwtVc);
                if (Format.JwtVp != null) formats.Add(PresentationExchangeConstants.Formats.JwtVp);
                if (Format.SdJwt != null) formats.Add(PresentationExchangeConstants.Formats.SdJwt);
                if (Format.SdJwtVc != null) formats.Add(PresentationExchangeConstants.Formats.SdJwtVc);
                if (Format.Ldp != null) formats.Add(PresentationExchangeConstants.Formats.Ldp);
                if (Format.LdpVc != null) formats.Add(PresentationExchangeConstants.Formats.LdpVc);
                if (Format.LdpVp != null) formats.Add(PresentationExchangeConstants.Formats.LdpVp);
