...
public class ConstraintEvaluationResult
{
    ...
    /// </summary>
    public DisclosureEvaluationResult? DisclosureResult
    {
        get; set;
    }
    ...
    /// </summary>
    public SubjectEvaluationResult? SubjectResult
    {
        get; set;
    }
...
public class FieldEvaluationResult
{
    ...
    /// </summary>
    public FilterEvaluationResult? FilterDetails
    {
        get; set;
    }
...
public class DisclosureEvaluationResult
{
    ...
    /// </summary>
    public bool SupportsSelectiveDisclosure
    {
        get; set;
    }
...
public class SubjectEvaluationResult
{
    ...
    /// </summary>
    public bool? SubjectEqualsIssuer
    {
        get; set;
    }
