...
public class RenderingMetadata {
...
#endif
        public SimpleRenderingMetadata? Simple { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
#endif
        public SvgTemplate[]? SvgTemplates { get; set; }
}
...
public class SimpleRenderingMetadata {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
#endif
        public LogoMetadata? BackgroundImage { get; set; }
...
public class SvgTemplate {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
#endif
        public SvgTemplateProperties? Properties { get; set; }
}
