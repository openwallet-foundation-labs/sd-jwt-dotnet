...
A .NET library for **Selective Disclosure JSON Web Tokens (SD-JWTs)** compliant with [RFC 9901](https://www.rfc-editor.org/rfc/rfc9901.html). This is the core library that provides SD-JWT issuance, holder presentation, and verification with algorithm enforcement, constant-time operations, and multi-platform support.
...
For more examples and advanced usage, see the [main repository](https://openwallet-foundation-labs.github.io/sd-jwt-dotnet/)
