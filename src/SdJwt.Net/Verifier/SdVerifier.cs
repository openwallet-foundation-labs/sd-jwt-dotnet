            ...
            bool strictMode) {
                ...
                if (node is JsonObject obj) {
                        ...
                        foreach (var key in obj.Select(kv => kv.Key).ToList()) {
                                if (obj[key] != null) usedDigests.UnionWith(SdVerifier.RehydrateNode(obj[key]!, availableDisclosures, hashAlgorithm, strictMode));
                        }
                }
                        ...
                        for (int i = 0; i < arr.Count; i++) {
                                ...
                                if (arr[i] != null) usedDigests.UnionWith(SdVerifier.RehydrateNode(arr[i]!, availableDisclosures, hashAlgorithm, strictMode));
                        }
